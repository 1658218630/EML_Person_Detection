...
class TinyYoloV2_Fused(nn.Module):
    ...
    def __init__(self, num_classes=20):
        ...
        # (Input channel, Output channel, kernel size, stride, padding, has bias)
        # conv1~conv8: kernel=3, stride=1, padding=1
        # conv9: kernel=1, stride=1, padding=0
        self.conv1 = nn.Conv2d(3, 16, 3, 1, 1, bias=True)  # It is fused with batchNorm, so now the bias=True
